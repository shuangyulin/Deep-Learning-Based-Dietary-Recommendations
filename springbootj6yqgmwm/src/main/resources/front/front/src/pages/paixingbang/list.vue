	...
	<div>
		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('paixingbang','新增')" type="primary" @click="add('/index/paixingbangAdd')">
					添加
				</el-button>
			</el-form>
			<div class="select2">
			...
			<div class="list">
				...
				<div class="list1 index-pv1">
					<div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
						...
						<div class="name">{{item.gengxinriqi}}</div>
						<div class="name">{{item.diyiming}}</div>
						<div class="name">使用次数:{{item.shiyongcishu}}</div>
						<div class="time_item">
